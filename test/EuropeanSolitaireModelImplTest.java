...
/**
 * Tests for the all the methods in EuropeanSolitaireModelImpl class.
 */
public class EuropeanSolitaireModelImplTest {
  ...
  public void moveException1() {
    MarbleSolitaireModel exampleBoard = new EuropeanSolitaireModelImpl();
  ...
  public void moveException4() {
    MarbleSolitaireModel exampleBoard = new EuropeanSolitaireModelImpl(4, 4);
  ...
  public void moveException5() {
    MarbleSolitaireModel exampleBoard = new EuropeanSolitaireModelImpl(2, 4);
  ...
  public void constExample1() {
    try {
      MarbleSolitaireModel exampleBoard = new EuropeanSolitaireModelImpl(0, 0);
      fail();
  ...
  public void constExample3() {
    MarbleSolitaireModel exampleBoard = new EuropeanSolitaireModelImpl(2);
  ...
  public void constExample4() {
    MarbleSolitaireModel exampleBoard = new EuropeanSolitaireModelImpl(0);
    exampleBoard.getGameState();
  }
  ...
  public void constExample5() {
    MarbleSolitaireModel exampleBoard = new EuropeanSolitaireModelImpl(-3);
    exampleBoard.getGameState();
  }
  ...
  public void constExample6() {
    try {
      MarbleSolitaireModel exampleBoard =
              new EuropeanSolitaireModelImpl(3, -2, 4);
      fail();
    } catch (IllegalArgumentException e) {
      assertEquals("Invalid empty cell position (-2,4)", e.getMessage());
    }
  ...
  public void moveExample2() {
    MarbleSolitaireModel exampleBoard = new EuropeanSolitaireModelImpl(5);
  ...
  public void scoreExample1() {
    MarbleSolitaireModel exampleBoard = new EuropeanSolitaireModelImpl();
    assertEquals(36, exampleBoard.getScore());
  }
  ...
  public void scoreExample2() {
    MarbleSolitaireModel exampleBoard = new EuropeanSolitaireModelImpl();
    exampleBoard.move(1, 3, 3, 3);
    assertEquals(35, exampleBoard.getScore());
  }
  ...
  public void scoreExample3() {
    MarbleSolitaireModel exampleBoard = new EuropeanSolitaireModelImpl(5);
    assertEquals(128, exampleBoard.getScore());
  }
  ...
  public void scoreExample4() {
    MarbleSolitaireModel exampleBoard = new EuropeanSolitaireModelImpl(5);
    exampleBoard.move(6, 4, 6, 6);
    assertEquals(127, exampleBoard.getScore());
  }
  ...
  public void scoreExample5() {
    ...
    assertEquals(true, exampleBoard.isGameOver());
    assertEquals(12, exampleBoard.getScore());
  }
